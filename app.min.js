angular.module("angularApp.controllers",["ui.bootstrap"]);var angularApp=angular.module("angularApp",["ngRoute","angularApp.controllers"]);angularApp.config(["$compileProvider",function(a){a.debugInfoEnabled(!1)}]);angularApp.filter("ticToTime",function(){return TimeFromTics});angularApp.directive("ngEnter",["$document",function(a){return{scope:{ngEnter:"&"},link:function(b,e,f){var c=function(d){13===d.which&&(b.ngEnter(),a.unbind("keydown keypress",c))};a.bind("keydown keypress",c)}}}]);
