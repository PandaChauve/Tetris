        ...
        function gameFactory(userInput, userStats, stateChecker, threeRendererFactory, tetrisFactory, TIC_PER_SEC, storage) {
            ...
            Game.prototype.startNewGame = function startNewGame() {
                ...
                for (var i = 0; i < this.gridCount; i += 1) {
                    ...
                    this.visual.push(threeRendererFactory.newRenderer(this.config.tetris[i].cursors, storage.get(storage.Keys.CubeTheme), this.availableGrids[0].scaleX, this.availableGrids[0].scaleY, storage.get(storage.Keys.ZoomConfig) || 2)); //FIXME [0]
